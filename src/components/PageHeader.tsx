  ...
  if (variant === 'hero') {
    return (
      ...
      >
        ...
        <div
          className={cn(
            'pointer-events-none absolute inset-x-10 bottom-0 h-px bg-[linear-gradient(90deg,rgba(26,43,95,0),rgba(26,43,95,0.18),rgba(16,133,69,0.18),rgba(26,43,95,0))]',
            heroAccentClassName
          )}
          aria-hidden
        />
            ...
            {(heroBadges?.length ? heroBadges : [{ icon: null as never }, { icon: null as never }, { icon: null as never }]).map((badge, index) => {
              if (!badge?.icon) {
                return (
                  <div
                    ...
                    className={cn(
                      index === 0 &&
                        'flex h-16 w-16 items-center justify-center rounded-[1.35rem] bg-header-navy shadow-[0_18px_45px_-28px_rgba(15,39,68,0.45)]',
                      index === 1 &&
                        'mt-10 flex h-14 w-14 items-center justify-center rounded-[1.2rem] bg-white ring-1 ring-header-navy/10 shadow-[0_16px_40px_-28px_rgba(15,39,68,0.28)]',
                      index === 2 &&
                        '-mt-8 flex h-12 w-12 items-center justify-center rounded-[1rem] bg-accent-green shadow-[0_16px_36px_-24px_rgba(16,133,69,0.42)]'
                    )}
                  />
                );
              }
              ...
              return (
                <div
                  ...
                  className={cn(
                    index === 0 &&
                      'flex h-16 w-16 items-center justify-center rounded-[1.35rem] bg-header-navy text-white shadow-[0_18px_45px_-28px_rgba(15,39,68,0.45)]',
                    index === 1 &&
                      'mt-10 flex h-14 w-14 items-center justify-center rounded-[1.2rem] bg-white text-header-navy ring-1 ring-header-navy/10 shadow-[0_16px_40px_-28px_rgba(15,39,68,0.28)]',
                    index === 2 &&
                      '-mt-8 flex h-12 w-12 items-center justify-center rounded-[1rem] bg-accent-green text-white shadow-[0_16px_36px_-24px_rgba(16,133,69,0.42)]',
                    badge.className
                  )}
                >
